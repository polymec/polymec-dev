...
function(add_brick_test exe sources)
  ...
  target_link_libraries(${exe} ${libs} ${BRICK_LIBS})
  add_test(${exe} ${exe})
endfunction(add_brick_test)
...
function(add_mpi_brick_test exe sources procs)
  if (ARGC EQUAL 5)
    set(libs ${ARG5})
  endif()
  add_executable(${exe} ${sources} cmockery.c)
  target_link_libraries(${exe} ${libs} brick)
  foreach (proc ${procs})
  ...
  endforeach()
endfunction(add_mpi_brick_test)

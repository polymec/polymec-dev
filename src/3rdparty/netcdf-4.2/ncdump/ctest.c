...
#   define RANK_var_ATSIGN_name_ATSIGN_ats 0
    ...
    {
    static const float Gf_att[3] = {((float)-9.9999996e+35), ((float)0), ((float)9.9999996e+35)} ;
    stat = nc_put_att_float(ncid, NC_GLOBAL, "Gf", NC_FLOAT, 3, Gf_att);
    check_err(stat,__LINE__,__FILE__);
    }

    {
    static const double Gd_att[3] = {((double)-1e+308), ((double)0), ((double)1e+308)} ;
    ...
    {
    static const float i_f_att[3] = {((float)-9.9999996e+35), ((float)0), ((float)9.9999996e+35)} ;
    stat = nc_put_att_float(ncid, i_id, "f", NC_FLOAT, 3, i_f_att);
    check_err(stat,__LINE__,__FILE__);
    }

    {
    static const double i_d_att[3] = {((double)-1e+308), ((double)0), ((double)1e+308)} ;
    ...
    stat = nc_put_var1(ncid, c_id, &zero, c_data);
    check_err(stat,__LINE__,__FILE__);
    }
    ...
    stat = nc_put_var1(ncid, b_id, &zero, b_data);
    check_err(stat,__LINE__,__FILE__);
    }
    ...
    stat = nc_put_var1(ncid, s_id, &zero, s_data);
    check_err(stat,__LINE__,__FILE__);
    }
    ...
    stat = nc_put_var1(ncid, i_id, &zero, i_data);
    check_err(stat,__LINE__,__FILE__);
    }
    ...
    stat = nc_put_var1(ncid, f_id, &zero, f_data);
    check_err(stat,__LINE__,__FILE__);
    }
    ...
    stat = nc_put_var1(ncid, d_id, &zero, d_data);
    check_err(stat,__LINE__,__FILE__);
    }
    ...
    stat = nc_put_var1(ncid, var_MINUS_name_MINUS_dashes_id, &zero, var_MINUS_name_MINUS_dashes_data);
    check_err(stat,__LINE__,__FILE__);
    }
    ...
    stat = nc_put_var1(ncid, var_PERIOD_name_PERIOD_dots_id, &zero, var_PERIOD_name_PERIOD_dots_data);
    check_err(stat,__LINE__,__FILE__);
    }

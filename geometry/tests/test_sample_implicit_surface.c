...
void test_sample_bbox_uniformly(void** state)
{
  ...
  int N;
  point_t* points = sample_implicit_surface(box, NULL, 1.0, &x0, &N);
...
void test_sample_cylinder_uniformly(void** state)
{
  ...
  int N;
  point_t* points = sample_implicit_surface(cylinder, NULL, 1.0, &x0, &N);
...
void test_sample_sphere_uniformly(void** state)
{
  ...
  int N;
  point_t* points = sample_implicit_surface(sphere, NULL, 1.0, &x0, &N);

...
docstring_t* cylindrical_1d_uniform_doc(void);
docstring_t* cylindrical_1d_uniform_doc()
{
  return docstring_from_string("cylindrical_1d.uniform(r1, r2, N) - returns a uniformly-spaced set of\n"
...
docstring_t* cylindrical_1d_logarithmic_doc(void);
docstring_t* cylindrical_1d_logarithmic_doc()
{
  return docstring_from_string("cylindrical_1d.logarithmic(r1, r2, log_factor, N) - returns a mesh of\n"
...
docstring_t* cylindrical_1d_nonuniform_doc(void);
docstring_t* cylindrical_1d_nonuniform_doc()
{
  return docstring_from_string("cylindrical_1d.nonuniform({r1, r2, ..., rN}) - returns a mesh of\n"

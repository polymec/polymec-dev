...
static void test_symplectic_central_force(void** state)
{
  ...
  ode_solver_t* I = symplectic_central_force_solver();
  real_t rel_tol = 1e-4, abs_tol = 1e-6;
  euler_ode_solver_set_tolerances(I, rel_tol, abs_tol);
...
static ode_solver_t* stiffly_accurate_kinetics_solver()
{
...
static void test_stiffly_accurate_kinetics(void** state)
{
  ...
  ode_solver_t* I = stiffly_accurate_kinetics_solver();
